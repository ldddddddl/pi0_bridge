...
def main(config: _config.TrainConfig):
    ...
    data_iter = iter(data_loader_bridge_train)
    ...
    if resuming:
        train_state = _checkpoints.restore_state(checkpoint_manager, train_state, data_loader_bridge_train)
    ...
    for step in pbar:
        ...
        if (step % config.save_interval == 0 and step > start_step) or step == config.num_train_steps - 1:
            _checkpoints.save_state(checkpoint_manager, train_state, data_loader_bridge_train, step)
