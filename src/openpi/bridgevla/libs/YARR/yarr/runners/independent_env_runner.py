...
from peract.utils.custom_rlbench_env import CustomMultiTaskRLBenchEnv
from peract.utils.custom_rlbench_env import CustomRLBenchEnv
import torch
...
class IndependentEnvRunner(EnvRunner):
    ...
    def start(self, weight, save_load_lock, writer_lock, env_config, device_idx, save_metrics, cinematic_recorder_cfg):
        ...
        self._internal_env_runner._run_eval_independent(
            "eval_env", stat_accumulator, weight, writer_lock, True, device_idx, save_metrics, cinematic_recorder_cfg
        )
