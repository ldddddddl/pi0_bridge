...
class PrioritizedReplayBuffer(UniformReplayBuffer):
    ...
    def get_storage_signature(self) -> tuple[list[ReplayElement], list[ReplayElement]]:
        ...
        """
        storage_elements, obs_elements = super(PrioritizedReplayBuffer, self).get_storage_signature()
    ...
    def add(self, action, reward, terminal, timeout, priority=None, **kwargs):
        ...
        super(PrioritizedReplayBuffer, self).add(action, reward, terminal, timeout, **kwargs)
    ...
    def set_priority(self, indices, priorities):
        ...
        """
        assert indices.dtype == np.int32, "Indices must be integers, " f"given: {indices.dtype}"
    ...
    def get_priority(self, indices):
        ...
        assert indices.dtype == np.int32, "Indices must be int32s, " f"given: {indices.dtype}"
