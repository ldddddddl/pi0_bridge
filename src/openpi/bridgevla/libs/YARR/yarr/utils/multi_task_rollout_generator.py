...
class RolloutGenerator:
    ...
    def generator(
        self, step_signal: Value, env: MultiTaskEnv, agent: Agent, episode_length: int, timesteps: int, eval: bool
    ):
        obs = env.reset()
        agent.reset()
        ...
        for step in range(episode_length):
            ...
            agent_extra_elems = {k: np.array(v) for k, v in act_result.replay_elements.items()}
